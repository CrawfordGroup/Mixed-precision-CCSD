...
ccsd = ccEnergy_sp(mol, rhf_e, rhf_wfn, numpy_memory=2)
...
for i in range(0, 3):
    ...
    ccpert[Mu + Om] = CCPert_sp(Mu, pert[Mu], ccsd, cclambda, omega)
    ccpert[L + Om] = CCPert_sp(L, pert[L], ccsd, cclambda, omega)
    ...
    print(
        ...
        % (Mu, Om))
    ccpert[Mu + Om].solve('right', r_conv=1e-6)

    print(
        '\nsolving left hand perturbed amplitudes for %s @ omega = %s a.u.\n' %
        (Mu, Om))
    ccpert[Mu + Om].solve('left', r_conv=1e-6)

    print(
        '\nsolving right hand perturbed amplitudes for %s @ omega = %s a.u.\n'
        % (L, Om))
    ccpert[L + Om].solve('right', r_conv=1e-6)

    print(
        '\nsolving left hand perturbed amplitudes for %s @ omega = %s a.u.\n' %
        (L, Om))
    ccpert[L + Om].solve('left', r_conv=1e-6)
...
for A in range(0, 3):
    ...
    for B in range(0, 3):
        ...
        cclinresp[str_AB] = CCLinresp_sp(cclambda, ccpert[str_A + Om],
                                            ccpert[str_B + Om])
        cclinresp[str_BA] = CCLinresp_sp(cclambda, ccpert[str_B + Om],
                                            ccpert[str_A + Om])

        tensor[str_AB] = cclinresp[str_AB].linresp_dp()
        tensor[str_BA] = cclinresp[str_BA].linresp_dp()
...
for i in range(0, 3):
    ...
    ccpert[P + Om] = CCPert_sp(P, pert[P], ccsd, cclambda, omega)

    # Solve X and Y amplitudes corresponding to the perturabtion at the given omega
    print(
        '\nsolving right hand perturbed amplitudes for %s @ omega = %s a.u.\n'
        % (P, Om))
    ccpert[P + Om].solve('right', r_conv=1e-6)

    print(
        '\nsolving left hand perturbed amplitudes for %s @ omega = %s a.u.\n' %
        (P, Om))
    ccpert[P + Om].solve('left', r_conv=1e-6)
...
for i in range(0, 3):
    ...
    ccpert[L + Om_0] = CCPert_sp(L, pert[L], ccsd, cclambda, 0)
    ccpert[P + Om_0] = CCPert_sp(P, pert[P], ccsd, cclambda, 0)
    ...
    print(
        '\nsolving right hand perturbed amplitudes for %s @ omega = %s (a.u.)\n'
        % (L, Om_0))
    ccpert[L + Om_0].solve('right', r_conv=1e-6)

    print(
        '\nsolving left hand perturbed amplitudes for %s @ omega = %s (a.u.)\n'
        % (L, Om_0))
    ccpert[L + Om_0].solve('left', r_conv=1e-6)

    print(
        '\nsolving right hand perturbed amplitudes for %s @ omega = %s (a.u.)\n'
        % (P, Om_0))
    ccpert[P + Om_0].solve('right', r_conv=1e-6)

    print(
        '\nsolving left hand perturbed amplitudes for %s @ omega = %s (a.u.)\n'
        % (P, Om_0))
    ccpert[P + Om_0].solve('left', r_conv=1e-6)
...
for A in range(0, 3):
    ...
    for B in range(0, 3):
        ...
        cclinresp[str_AB] = CCLinresp_sp(cclambda, ccpert[str_A + Om_0],
                                            ccpert[str_B + Om_0])
        cclinresp[str_BA] = CCLinresp_sp(cclambda, ccpert[str_B + Om_0],
                                            ccpert[str_A + Om_0])
