...
for i in range(0, 3):
    ...
    ccpert[Mu + Om] = CCPert_dp(Mu, pert[Mu], ccsd, cclambda, omega)
    ccpert[L + Om] = CCPert_dp(L, pert[L], ccsd, cclambda, omega)
...
for A in range(0, 3):
    ...
    for B in range(0, 3):
        ...
        cclinresp[str_AB] = CCLinresp_dp(cclambda, ccpert[str_A + Om],
                                            ccpert[str_B + Om])
        cclinresp[str_BA] = CCLinresp_dp(cclambda, ccpert[str_B + Om],
                                            ccpert[str_A + Om])
...
for i in range(0, 3):
    ...
    ccpert[P + Om] = CCPert_dp(P, pert[P], ccsd, cclambda, omega)
...
for i in range(0, 3):
    ...
    ccpert[L + Om_0] = CCPert_dp(L, pert[L], ccsd, cclambda, 0)
    ccpert[P + Om_0] = CCPert_dp(P, pert[P], ccsd, cclambda, 0)
...
for A in range(0, 3):
    ...
    for B in range(0, 3):
        ...
        cclinresp[str_AB] = CCLinresp_dp(cclambda, ccpert[str_A + Om_0],
                                            ccpert[str_B + Om_0])
        cclinresp[str_BA] = CCLinresp_dp(cclambda, ccpert[str_B + Om_0],
                                            ccpert[str_A + Om_0])
