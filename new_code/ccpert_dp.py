...
class CCPert_dp(object):
    def __init__(self, name, pert, ccsd, cclambda, omega):
        ...
        self.t1 = ccsd.t1
        self.t2 = ccsd.t2
        self.ttau = cclambda.build_tau(self.t1, self.t2)
        self.Loovv = cclambda.build_Loovv()
        self.Looov = cclambda.build_Looov()
        self.Lvovv = cclambda.build_Lvovv()
        self.Hov = cclambda.build_Hov(self.F, self.t1)
        self.Hvv = cclambda.build_Hvv(self.F, self.t1, self.t2)
        self.Hoo = cclambda.build_Hoo(self.F, self.t1, self.t2)
        self.Hoooo = cclambda.build_Hoooo(self.t1, self.t2)
        self.Hvvvv = cclambda.build_Hvvvv(self.t1, self.t2)
        self.Hvovv = cclambda.build_Hvovv(self.t1)
        self.Hooov = cclambda.build_Hooov(self.t1)
        self.Hovvo = cclambda.build_Hovvo(self.t1, self.t2)
        self.Hovov = cclambda.build_Hovov(self.t1, self.t2)
        self.Hvvvo = cclambda.build_Hvvvo(self.F, self.t1, self.t2)
        self.Hovoo = cclambda.build_Hovoo(self.F, self.t1, self.t2)
        self.l1 = cclambda.l1
        self.l2 = cclambda.l2
        self.omega = omega
    ...
    def solve(self, hand, r_conv=1.e-7, maxiter=100, max_diis=8, start_diis=100):
