...
class ccHbar(object):
    ...
    def __init__(self, ccsd):
        ...
        print('\n..HBAR Build completed in %.3f seconds!' % (time.time() - time_init))
    ...
    def build_Hoooo(self):
        ...
        """
        self.Hoooo = self.get_MO('oooo').copy() + 0.0j
    ...
    def build_Hvvvv(self):
        ...
        """
        self.Hvvvv = self.get_MO('vvvv').copy() + 0.0j
    ...
    def build_Hovvo(self):
        ...
        """
        self.Hovvo = self.get_MO('ovvo').copy() + 0.0j
    ...
    def build_Hovov(self):
        ...
        """
        self.Hovov = self.get_MO('ovov').copy() + 0.0j
    ...
    def build_Hvvvo(self):
        ...
        self.Hvvvo = self.get_MO('vvvo').copy() + 0.0j
    ...
    def build_Hovoo(self):
        ...
        self.Hovoo = self.get_MO('ovoo').copy() +0.0j
